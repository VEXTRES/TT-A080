<div>
    <x-app-layout>
        ...
        <div class="w-full max-h-screen">
            ...
            <div class="border gap-3 border-black grid grid-cols-3 w-4/5 mx-auto max-h-screen my-14">
                ...
                <div class="col-span-{{$comidas->isEmpty()?3:1}} bg-white p-3 rounded-md flex flex-col justify-center space-y-4">
                    ...
                    @if ($comidas->isNotEmpty())
                        @foreach ($comidas as $comida)
                            <div class="col-span-1 bg-white gap-3 p-3 rounded-md flex flex-col justify-center space-y-4">
